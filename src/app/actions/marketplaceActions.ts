  ...
  try {
    ...
    return {
      ...
      diagnostics: {
        ...
        discoveryQueries: telemetry.discoveryQueries,
        searchResultsReturned: telemetry.searchResultsReturned,
        catawikiCandidateUrls: telemetry.catawikiCandidateUrls,
        uniqueLotIds: telemetry.uniqueLotIds,
        lotPagesRequested: telemetry.lotPagesRequested,
        lotPagesSuccessfullyFetched: telemetry.lotPagesSuccessfullyFetched,
        completedLotsDetected: telemetry.completedLotsDetected,
        finalPricesExtracted: telemetry.finalPricesExtracted,
        productMatchesAccepted: telemetry.productMatchesAccepted,
        persistedSoldComparables: telemetry.persistedSoldComparables,
